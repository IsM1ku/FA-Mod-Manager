...
execute_psc "controlsProdigal.psc"	 // runs script	that binds controls

///DEBUG/// run DebugPoints

execute_psc "ProdigalHUDSetup.psc"
...
// Launch the game into DevUI rather than the front end
g_LaunchMode 1
...
// Prodigal specific stuff goes here
cameraFOVsetting .85
speedFXRange "60 100"
speedFXMaxCameraShakeLin 0.003
speedFXMaxCameraShakeAng 0.003
speedFXFOV .7
g_piProjectID 0 // This is prodigal
g_forceTargetCycling 1
aiVerbose 1536


//[dh] temporary... set the default player car and weapon to be the right thing.
g_defaultP0CarIndex 31
g_defaultP0PrimaryWeaponID 10
g_defaultP0SecondaryWeaponID 0

// Ensure the right script data is present
ScriptTargetsFile "ProdigalScriptTargets.dat"

// [ch] temporary -- forces all competitors to use the 20mm cannon, and EmptyWeapon.
forceWeapon0 11
forceWeapon1 1
